...
<div>
    <!-- header -->
    <div class="bg-white">
        <kuc-page-header @back="handleRoute" disabled :title="$t('group.manage')" class="border-bottom" style="border-bottom-color: #f7f7f7 !important"></kuc-page-header>
    </div>
    ...
    <div class="bg-white px-2">
        <div class="" v-for="item in group_for_buyer" :key="item.id">
        ...
        <no-data v-if="!group_for_buyer.length"></no-data>
    </div>
</div>
</template>
